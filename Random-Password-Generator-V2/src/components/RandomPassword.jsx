...
const RandomPassword = () => {
  ...
  const passwordGeneratorHandler = (e) => {
    ...
    if (characters.length) {
      ...
      enqueueSnackbar('At least one check box must be selected', {
        variant: 'error',
  ...
  return (
    <div className='flex flex-col bg-white max-w-md w-full rounded-xl py-12 px-6 shadow-custom'>
      ...
      <div className='flex flex-col gap-y-2 mt-8 px-2'>
        {/* #1 */}
        <div className='flex items-center gap-x-2'>
          <input
            ...
            type='checkbox'
            value={isLower}
            onClick={(e) => setIsLower(!isLower)}
            className='w-4 h-4 bg-transparent border-neutral-500 rounded-lg outline-none accent-violet-400 focus:rounded-lg '
          />
          <label
            htmlFor='lowercase'
        ...
        <div className='flex items-center gap-x-2'>
          <input
            ...
            type='checkbox'
            value={isNumber}
            onClick={(e) => setIsNumber(!isNumber)}
            className='w-4 h-4 bg-transparent border-neutral-500 rounded-lg outline-none accent-violet-400 focus:rounded-lg '
          />
          <label
            htmlFor='numberChars'
        ...
        <div className='flex items-center gap-x-2'>
          <input
            id='specialChars'
            type='checkbox'
            value={isSpecialChars}
            onClick={(e) => setIsSpecialChars(!isSpecialChars)}
            className='w-4 h-4 bg-transparent border-neutral-500 rounded-lg outline-none accent-violet-400 focus:rounded-lg '
          />
          <label
